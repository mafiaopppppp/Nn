...
# ==========================================
TOKEN = '8560137122:AAH_ORZ6NqwoiqjpX8D5w4jGEPZveGfJTJs'
ADMIN_ID = 1885926472
OWNER_USERNAME = "@Mafiaop08"
BOT_USERNAME = "@Mafiaop0777_bot"
LOG_GROUP_ID = -1002679675414 

# Default force channels (updated with your channels)
FORCE_CHANNELS = [
    {
        "channel_username": "@MAFIAOP09",
        "channel_link": "https://t.me/MAFIAOP09",
        "channel_type": "public",
        "added_by": ADMIN_ID,
...
def referral_system(m):
    ...
    mk.add(types.InlineKeyboardButton("📤 Share Referral", url=f"https://t.me/share/url?url=https://t.me/{BOT_USERNAME[1:]}?start={referral_code}&text=Join%20Neon%20Master%20Bot%20for%20free%20file%20hosting%2C%20hacking%20tools%2C%20OTP%20bomber%20and%20more!"))
